...
func (c *Cache) Fetch(ctx context.Context, client pixiv.PixivImageClient, rankingType pixiv.RankingType, page int, r18 bool) error {
	images, err := client.FetchRanking(ctx, rankingType, page, r18)
	if err != nil {
		return err
	}
